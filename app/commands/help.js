...
module.exports = {
  name: "awdkawdkaolwdkaıdkawıdk",
  description: "adşwöldawç",
  execute(client, message) {
  message.channel.send(new Discord.MessageEmbed()
                      .setDescription(
`   
  
**  🎧 | Lexnay Bot Keyifli Dinlemeler Diler. Beni Tercih Ettiğiniz İçin Teşekkürler **
...
**Lexnay Bot | 2021 © Tüm Hakları Saklıdır**
